...
let [userError, setUserError] = useState({ emailError: "", passwordError: "",});
  ...
  let submitLogin = async(event) => {
    ...
    if (user.email !== "" && user.password !== "") {
        ...
        // It uses Axios to make a POST request to the URL 
        //   with the email and password as the request data
     const {status,data}=await axios.post('https://devroom-backend-8m7a.onrender.com/api/users/login',{email,password},{
        headers:{
              ...
              <form onSubmit={submitLogin}>
                <div className="form-group">
                  ...
                  <input
                    ...
                    placeholder="Email" 
                  />
                 {/*   display error into UI or nothing in case not fount error */}
